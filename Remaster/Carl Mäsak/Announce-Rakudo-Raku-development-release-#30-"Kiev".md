# Announce: Rakudo Raku development release #30 ("Kiev")
    
*Originally published on [18 June 2010](http://strangelyconsistent.org/blog/announce-rakudo-perl-6-development-release-30-kiev) by Carl Mäsak.*

On behalf of the Rakudo development team, I'm pleased to announce the June2010 development release of Rakudo Perl #30 "Kiev". Rakudo is an implementation of Raku on the Parrot Virtual Machine (see [www.parrot.org](http://www.parrot.org)). The tarball for the June 2010 release is available from [Github](https://github.com/rakudo/rakudo/downloads).
...
For a more detailed list of changes see [docs/ChangeLog](https://github.com/rakudo/rakudo/blob/master/docs/ChangeLog).

The development team thanks all of our contributors and sponsors for making Rakudo Perl possible, as well as those people who worked on parrot, the Raku test suite and the specification.
...
If you would like to contribute, see ["How to help"](https://rakudo.org/community), ask on the mailing list, or ask on IRC #raku on libera.chat.

The next release of Rakudo (#31) is scheduled for July 22, 2010. A list of the other planned release dates and code names for 2010 is available in the [docs/release_guide.pod](https://github.com/rakudo/rakudo/blob/master/docs/release_guide.pod) file. In general, Rakudo development releases are scheduled to occur two days after each Parrot monthly release. Parrot releases the third Tuesday of each month.
