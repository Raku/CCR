...
*Originally published on [5 February 2011](http://strangelyconsistent.org/blog/yapsi-201102-released) by Carl Mäsak.*
...
6 compiler written in Raku.

You can download it [here](https://github.com/downloads/masak/yapsi/yapsi-2011.02.tar.gz).
...
Yapsi is an "official and complete" implementation of Raku. This has been
...
Also, Yapsi has the cutest AST output of all the Raku implementations:
