...
*Originally published on [2 May 2011](http://strangelyconsistent.org/blog/yapsi-201105-released) by Carl Mäsak.*

It is with superfluous glee that I announce on behalf of the Yapsi development team the May 2011 release of Yapsi, a Raku compiler written in Raku. Yeah.

You can download it [here](https://github.com/downloads/masak/yapsi/yapsi-2011.05.tar.gz).

Yapsi is implemented in Raku. It thus requires a Raku implementation to build and run. This release of Yapsi has been confirmed to work on all releases of Rakudo Star to date.

Yapsi is an "official and complete" implementation of Raku. By general agreement, no Raku implementation is "the official implementation"... which is why Yapsi only makes claims to be "AN official implementation". Similarly, it's only "complete" in a very restricted sense, namely "not really complete".
...
An overarching goal for making a Raku compiler-and-runtime is to use it as a server for various other projects, which hook in at different steps:

- A time-traveling debugger (tardis), which hooks into the runtime. Already underway, see https://github.com/masak/tardis
