...
*Originally published on [10 May 2008](https://use-perl.github.io/user/pmichaud/journal/36375/) by Patrick Michaud.*
...
The Parrot developers could really use some help with reviewing the Parrot RT queue.  Personally I think that a good number of those 700 open tickets must be irrelevant by now or otherwise already addressed.  Coke wrote a [nice set of guidelines](https://web.archive.org/web/20110723122550/http://www.parrotblog.org/2008/05/700-ticket-challenge.html) for this, if you're interested in helping.  
...
I also cleared out a few RT tickets from the "raku" queue, applying several useful patches and closing some out-of-date tickets.  This leaves us with 22 new/open tickets for Rakudo, although I expect that number to grow as more people start playing with it and trying out various tests.
